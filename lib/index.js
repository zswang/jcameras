    ...
    var Player = /** @class */ (function () {
        ...
        Player.prototype.render = function () {
            ...
            this.records.forEach(function (item, index) {
                ...
                switch (item.type) {
                    case 'dblclick':
                        double.push("<use xlink:href=\"#mouse-double\" transform=\"translate(" + point.x + "," + point.y + ")\" />");
                        break;
                    case 'mousemove':
                    ...
                    case 'click':
                        ...
                        break;
                    case 'mousewheel':
                        wheel.push("<use xlink:href=\"#mouse-middle\" transform=\"translate(" + point.x + "," + point.y + ")\" />");
                        break;
                    case 'contextmenu':
                        menu.push("<use xlink:href=\"#mouse-right\" transform=\"translate(" + point.x + "," + point.y + ")\" />");
                        break;
                }
            });
            if (downPoint) {
