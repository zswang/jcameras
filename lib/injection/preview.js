...
(function (root, factory) {
    ...
    var Parser = /** @class */ (function () {
        ...
        Parser.prototype.stringify = function (session) {
            ...
            var result = "" + this.options.prefix + short(this.options.version, 2) + session.session + short(session.seq, 2) + short(Math.floor(session.timestamp / 1000) % 2821109907455 /* {36}zzzzzzzz */, 8);
            return result;
        };
        return Parser;
    }()); /*</function>*/
